###################################################################
## Bio 261, Coursework 2 Report
##
## Title: Population Dynamics in fisheries
##
## Author: Rhys Cousins
##
## Date: 19/04/2024
...
## Content
##
## R codes for all of the figures included in the report 
##################################################################
## Figure 1
##################################################################
...
## When this simulation is run the values that are contained in Figure 2
## are observed. Along with the True or False for the population stability.
